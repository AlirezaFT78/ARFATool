class Normalizer:
    ...
    def __init__(
        ...
        self.norm_dict.update({'ﷲ':'الله', 'ريال':'ريال', 'ؐ':'(ص)', 'ؑ':'(ع)', 'ؒ':'(ره)', 'ؓ':'(رض)'})
    ...
    def normalize(self, txt):
        ...
        دارند مانندالله یا ریال خود کلمه قرار می گیرد. در یونکد فرم های غیراستاندارد فارسی (عربی) هر حرف 3
